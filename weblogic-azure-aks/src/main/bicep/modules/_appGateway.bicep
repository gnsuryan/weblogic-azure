...
param appgwCertificateOption string
param appgwName string
param appgwPublicIPAddressName string
@secure()
param appgwSSLBackendRootCertData string
param appgwUsePrivateIP bool
param azCliVersion string = ''
param autoGeneratedSSLCertKeyVaultName string
param autoGeneratedSSLCertSecretName string
...
param sslCertificateDeploymentName string
@secure()
...
var _selfSignedFrontendCertAndNoBackendCert = appgwCertificateOption == 'generateCert' && !enableCustomSSL
var _selfSignedFrontendCertAndBackendCert = appgwCertificateOption == 'generateCert' && enableCustomSSL
var _signedFrontendCertAndNoBackendCert = appgwCertificateOption == 'haveCert' && !enableCustomSSL
var _signedFrontendCertAndBackendCert = appgwCertificateOption == 'haveCert' && enableCustomSSL
...
module appgwDeployment1 '_azure-resoruces/_appgateway.bicep' = if (_selfSignedFrontendCertAndNoBackendCert) {
  ...
  params: {
    ...
    gatewaySslCertName: sslCertificateDeploymentName
    gatewayTrustedRootCertName: trustedRootCertificateDeploymentName
    location: location
    noSslCertPsw: true
